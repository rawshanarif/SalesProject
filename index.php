                  ...
                  <div class="container-fluid">
					  ...
					  <p id="price">$2,000</p>
                              ...
                              <div class="col-lg-3 prod wow fadeInUp" data-wow-delay="1.1s">
                                          <form action="increment.php" method="post">                                                      
					  <p id="price">USD $10000</p>
                                          <input type="text" id="price" name="price" value="10" style="display: none">
					  <img src="images/baby.jpg" alt="">
                                          <button class="btn">Purchase</button>
                                          <p id="prod-desc">Baby Yoda<br>It's not a part of the Dark Side but everyone needs a Baby Yoda</p>
                                          <input type="text" id="product" name="product" value="BabyYoda"  style="display: none">
                             </form> </div>
                              <div class="col-lg-3 prod wow fadeInUp" data-wow-delay="1.4s">
                                   <form action="increment.php" method="post">
					  <p id="price">USD $250</p>
                                          <input type="text" id="price" name="price" value="25" style="display: none">
					  <img src="images/grievous.jpg" alt="">
                                          <button class="btn">Purchase</button>
					  <p id="prod-desc">General Grievous Apprenticeship</p>
                                        <input type="text" id="product" name="product" value="Apprenticeship"  style="display: none">
                                   </form> 
                              </div>
                        </div>
                  </div>
                  ...
                  <div class="container-fluid">
                        <div class="row some-cards">
                              ...
                              <div class="col-lg-3 prod wow fadeInUp" data-wow-delay="0.7s">
                                    ...
                                    <p id="prod-desc">Dark Side Handbook comes free with every purchase</p>
                              </div>
                        </div>
                  </div>
            </div>
